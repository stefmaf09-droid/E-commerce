...
def get_i18n_text(key: str, lang: str = None) -> str:
    ...
    translations = {
        'FR': {
            ...
            'pod_status_caption': 'Visualisez la disponibilité des preuves de livraison et relancez les échecs',
            'pod_available': 'POD Disponibles',
            'pod_pending': 'En attente',
            'pod_failed': 'Échecs',
            'pod_not_requested': 'Non demandés',
            'pod_available_for': 'POD disponible',
            'pod_failed_for': 'Échec POD',
            'pod_fetching': 'POD en cours de récupération',
            'pod_url_unavailable': 'URL non disponible',
            'pod_error': 'Erreur',
            'btn_retry': 'Réessayer',
            'btn_retry_all': 'Réessayer tous les échecs',
            'btn_download_pod': 'Télécharger',
            'pod_bulk_retry_complete': 'Réessai en masse terminé !',
            'pod_bulk_success': 'Succès',
            'pod_bulk_failed': 'Échecs',
            'pod_bulk_skipped': 'Ignorés (rate limit)',
            'pod_bulk_processing': 'Traitement',
            
            # POD Email Notifications
            'email_pod_retrieved_subject': 'Preuve de livraison disponible',
            'email_pod_retrieved_title': 'POD récupéré avec succès',
            'email_pod_retrieved_message': 'La preuve de livraison pour votre réclamation {claim_ref} est maintenant disponible.',
            'email_pod_failed_subject': 'POD non disponible - Action requise',
            'email_pod_failed_title': 'Récupération POD impossible',
            'email_pod_failed_message': 'Nous n\'avons pas pu récupérer la preuve de livraison pour votre réclamation {claim_ref}.',
            'email_pod_reason': 'Raison',
            'email_pod_action_required': 'Veuillez vérifier le numéro de suivi auprès du transporteur.',
            'email_greeting': 'Bonjour',
            'email_signature_team': 'L\'équipe Refundly',
            'email_view_claim': 'Consulter la réclamation',
            'email_manage_preferences': 'Vous pouvez gérer vos préférences de notifications',
            'email_here': 'ici',
            
            # Claims Management Page
            'claims_management_title': 'Gestion des Litiges',
            'claims_management_caption': 'Visualisez et gérez vos réclamations en masse',
            'total_claims': 'Total litiges',
            'claims_accepted': 'Acceptés',
            'claims_pending': 'En cours',
            'claims_rejected': 'Rejetés',
            ...
            'btn_delete_selection': 'Supprimer sélection',
            'btn_confirm_delete': 'Confirmer la suppression',
            'btn_cancel': 'Annuler',
            'delete_warning': 'Attention : La suppression est définitive !',
            'claims_deleted': 'Litiges supprimés',
            'client_not_found': 'Client non trouvé',
            'error_loading_claims': 'Erreur lors du chargement des litiges',
            'csv_ready': 'litiges prêts à être exportés !',
            'error_export': 'Erreur lors de l\'export',
            'no_tracking': 'Impossible de réessayer: numéro de suivi manquant',
            'rate_limit_reached': 'Limite d\'API atteinte pour {carrier}. Réessayez après {time}',
            'retrieving_pod': 'Récupération POD pour {tracking}...',
            'pod_status_available': 'POD disponible - {claim_ref}',
            'pod_status_failed': 'Échec POD - {claim_ref}',
            'pod_status_fetching': 'POD en cours de récupération - {claim_ref}',
            'pod_retrieved_success': 'POD récupéré avec succès!',
            'pod_retrieved_notification_failed': 'POD récupéré mais notification échouée: {error}',
            'pod_failed_error': 'Échec: {error}',
            'notification_failed': 'Notification échouée: {error}',
            'notification_sent_persistent': 'Email envoyé (erreur persistante)',
            'notification_temp_error': 'Erreur temporaire - pas d\'email envoyé',
            'no_failed_pods': 'Aucun POD en échec à réessayer',
            'bulk_retry_processing': 'Traitement {current}/{total}: {claim_ref}',
            'bulk_retry_summary': 'Réessai en masse terminé !',
            'bulk_retry_success_count': 'Succès',
            'bulk_retry_failed_count': 'Échecs',
            'bulk_retry_skipped_count': 'Ignorés (rate limit)',
            'download_csv': 'Télécharger le CSV',
            'error_pod_retrieval': 'Erreur lors de la récupération POD: {error}',
            'pod_not_available': 'POD non disponible',
            'pod_file_not_found': 'Fichier POD introuvable',
            'pod_gallery': 'Galerie POD',
            'select_pod': 'Sélectionner un POD',
            'no_pods_available': 'Aucun POD disponible',
            'previous': 'Précédent',
            'next': 'Suivant',
            'view_pod': 'Voir POD',
            'btn_retry_pod': 'Réessayer',
            'pod_analytics_title': 'Analytiques POD',
            'pod_analytics_subtitle': 'Performance de récupération des preuves de livraison',
            'time_range': 'Période',
            'last_7_days': '7 derniers jours',
            'last_30_days': '30 derniers jours',
            'last_90_days': '90 derniers jours',
            'all_time': 'Depuis le début',
            'no_pod_data': 'Aucune donnée POD disponible',
            ...
            'no_carrier_data': 'Aucune donnée transporteur',
            'retry_analysis': 'Analyse des réessais',
            'no_retry_data': 'Aucune donnée de réessai',
            'retry_summary': 'Résumé',
            ...
            'connected_stores': 'Vos boutiques connectées',
            'sync': 'Synchroniser',
            'delete': 'Supprimer',
            'store_deleted': 'Boutique supprimée',
            'confirm_delete': 'Cliquez à nouveau pour confirmer',
            'no_stores': 'Aucune boutique connectée pour le moment',
            ...
            'store_added_success': 'Boutique {store_name} ajoutée avec succès !',
            'error_adding_store': 'Erreur lors de l\'ajout de la boutique',
            'platform_info': 'Informations Plateforme',
            'platform_info_caption': 'Détails de connexion à votre plateforme e-commerce',
            'store_url_label': 'URL de la boutique',
            'connection_status': 'Statut de connexion',
            'connected': 'Connecté',
            'api_credentials': 'Identifiants API',
            'no_api_key': 'Aucune clé API enregistrée',
            'credentials_encrypted': 'Les identifiants complets sont chiffrés et stockés en sécurité',
            'no_store_selected': 'Aucune boutique sélectionnée. Veuillez d\'abord connecter une boutique.',
            'bank_info': 'Informations Bancaires',
            'bank_info_caption': 'Vos coordonnées pour recevoir les remboursements (80% des montants récupérés)',
            'iban': 'IBAN',
            'bic': 'BIC/SWIFT',
            'account_holder': 'Titulaire du compte',
            'bank_name': 'Nom de la banque',
            'bank_info_saved': 'Informations bancaires enregistrées',
            'edit_bank_info': 'Modifier mes coordonnées bancaires',
            'no_bank_info': 'Vous n\'avez pas encore renseigné vos coordonnées bancaires',
            ...
            'add_bank_info': 'Ajouter mes coordonnées bancaires',
            'save': 'Enregistrer',
            'iban_holder_required': 'L\'IBAN et le titulaire sont obligatoires',
            'bank_info_saved_success': 'Coordonnées bancaires enregistrées avec succès !',
            'notification_prefs': 'Préférences de Notifications Email',
            'notification_prefs_caption': 'Contrôlez les emails que vous recevez pour ne jamais être submergé',
            'notification_types': 'Types de notifications',
            'notification_types_caption': 'Décochez les notifications que vous ne souhaitez pas recevoir',
            'notif_claim_created': 'Nouveau litige créé',
            'notif_claim_updated': 'Mise à jour du litige',
            'notif_claim_accepted': 'Litige accepté',
            ...
            'freq_immediate': 'Immédiat (dès que l\'événement se produit)',
            'freq_daily': 'Quotidien (résumé une fois par jour à 9h)',
            'freq_weekly': 'Hebdomadaire (résumé le lundi matin)',
            'frequency_tip': 'Astuce : Si vous recevez beaucoup de litiges, le mode \'Quotidien\' vous évitera d\'être submergé d\'emails.',
            ...
            'templates_info': 'Vous pouvez personnaliser les emails envoyés automatiquement lors des escalades (demande de statut, avertissement, mise en demeure).',
            'custom_templates': '{count} template(s) personnalisé(s)',
            ...
            'sync_successful': 'Synchronisation réussie',
            'orders_analyzed': '{count} commandes analysées',
        ...
        'EN': {
            ...
            'legal_law_fl': 'Under the Florida Deceptive and Unfair Trade Practices Act (FDUTPA) and Florida Statutes § 677.309, a carrier is liable for damages for loss of or injury to the goods caused by its failure to exercise reasonable care.',
        ...
        'DE': {
            ...
            'pod_bulk_skipped': 'Übersprungen (Rate Limit)',
            'pod_bulk_processing': 'Verarbeitung',
            
            # POD Email Notifications
            'email_pod_retrieved_subject': 'Zustellnachweis verfügbar',
            'email_pod_retrieved_title': 'POD erfolgreich abgerufen',
            'email_pod_retrieved_message': 'Der Zustellnachweis für Ihre Reklamation {claim_ref} ist jetzt verfügbar.',
            'email_pod_failed_subject': 'POD nicht verfügbar - Aktion erforderlich',
            'email_pod_failed_title': 'POD-Abruf fehlgeschlagen',
            'email_pod_failed_message': 'Wir konnten den Zustellnachweis für Ihre Reklamation {claim_ref} nicht abrufen.',
            'email_pod_reason': 'Grund',
            'email_pod_action_required': 'Bitte überprüfen Sie die Sendungsnummer beim Frachtführer.',
            'email_greeting': 'Guten Tag',
            'email_signature_team': 'Das Refundly-Team',
            'email_view_claim': 'Reklamation ansehen',
            'email_manage_preferences': 'Sie können Ihre Benachrichtigungseinstellungen verwalten',
            'email_here': 'hier',
            ...
            'btn_confirm_delete': 'Löschung bestätigen',
            'btn_cancel': 'Abbrechen',
            'delete_warning': 'Achtung: Löschung ist endgültig!',
            'claims_deleted': 'Reklamationen gelöscht',
            ...
            'no_tracking': 'Wiederholung nicht möglich: Sendungsnummer fehlt',
            'rate_limit_reached': 'API-Limit für {carrier} erreicht. Erneut versuchen nach {time}',
            'retrieving_pod': 'POD wird abgerufen für {tracking}...',
            'pod_status_available': 'POD verfügbar - {claim_ref}',
            ...
            'notification_temp_error': 'Vorübergehender Fehler - keine E-Mail gesendet',
            ...
            'bulk_retry_skipped_count': 'Übersprungen (Rate Limit)',
            'download_csv': 'CSV herunterladen',
            'error_pod_retrieval': 'Fehler beim Abrufen des POD: {error}',
            'pod_not_available': 'POD nicht verfügbar',
            'pod_file_not_found': 'POD-Datei nicht gefunden',
            'pod_gallery': 'POD-Galerie',
            'select_pod': 'POD auswählen',
            'no_pods_available': 'Keine PODs verfügbar',
            'previous': 'Zurück',
            'next': 'Weiter',
            ...
            'no_pod_data': 'Keine POD-Daten verfügbar',
            'overview_metrics': 'Übersicht',
            ...
            'avg_daily_pods': 'Täglich durchschn.',
            'success': 'Erfolg',
            'avg': 'Durchschn.',
            ...
            'store_management_caption': 'Fügen Sie Ihre E-Commerce-Shops hinzu, synchronisieren oder löschen Sie sie',
            'connected_stores': 'Ihre verbundenen Shops',
            'sync': 'Synchronisieren',
            'delete': 'Löschen',
            'store_deleted': 'Shop gelöscht',
            'confirm_delete': 'Zum Bestätigen erneut klicken',
            'no_stores': 'Noch keine Shops verbunden',
            'add_store': 'Neuen Shop hinzufügen',
            ...
            'api_secret': 'API-Secret',
            'add_this_store': 'Diesen Shop hinzufügen',
            'all_fields_required': 'Alle Felder sind erforderlich',
            'store_added_success': 'Shop {store_name} erfolgreich hinzugefügt!',
            'error_adding_store': 'Fehler beim Hinzufügen des Shops',
            ...
            'no_api_key': 'Kein API-Schlüssel registriert',
            'credentials_encrypted': 'Vollständige Anmeldedaten sind verschlüsselt und sicher gespeichert',
            'no_store_selected': 'Kein Shop ausgewählt. Bitte verbinden Sie zuerst einen Shop.',
            'bank_info': 'Bankinformationen',
            'bank_info_caption': 'Ihre Daten zum Erhalt von Erstattungen (80% der wiedererlangten Beträge)',
            'iban': 'IBAN',
            'bic': 'BIC/SWIFT',
            ...
            'bank_info_reason': 'Um Ihre Erstattungen automatisch zu erhalten, benötigen wir Ihre IBAN.',
            'add_bank_info': 'Meine Bankdaten hinzufügen',
            'save': 'Speichern',
            ...
            'notification_prefs_caption': 'Kontrollieren Sie die E-Mails, die Sie erhalten, um nicht überwältigt zu werden',
            'notification_types': 'Benachrichtigungstypen',
            'notification_types_caption': 'Deaktivieren Sie Benachrichtigungen, die Sie nicht erhalten möchten',
            ...
            'frequency': 'Sendehäufigkeit',
            'frequency_caption': 'Wählen Sie, wie Sie Ihre Benachrichtigungen erhalten möchten',
            'freq_immediate': 'Sofort (sobald das Ereignis eintritt)',
            'freq_daily': 'Täglich (Zusammenfassung einmal täglich um 9 Uhr)',
            'freq_weekly': 'Wöchentlich (Zusammenfassung am Montagmorgen)',
            'frequency_tip': 'Tipp: Wenn Sie viele Reklamationen erhalten, verhindert der \'Täglich\'-Modus eine E-Mail-Flut.',
            ...
            'templates_info': 'Sie können E-Mails anpassen, die automatisch bei Eskalationen gesendet werden (Statusanfrage, Warnung, Mahnung).',
        ...
        'IT': {
            ...
            'pod_status_caption': 'Visualizza disponibilità prove di consegna e riprova errori',
            ...
            'email_pod_retrieved_message': 'La prova di consegna per il tuo reclamo {claim_ref} è ora disponibile.',
            ...
            'btn_cancel': 'Annulla',
            'delete_warning': 'Attenzione: L\'eliminazione è definitiva!',
            ...
            'why_important': 'Perché è importante?',
            ...
            'freq_weekly': 'Settimanale (riepilogo il lunedì mattina)',
            'frequency_tip': 'Suggerimento: se ricevi molti reclami, la modalità \'Giornaliero\' eviterà il sovraccarico di email.',
        ...
        'ES': {
            ...
            'email_pod_retrieved_title': 'POD recuperado con éxito',
            'email_pod_retrieved_message': 'La prueba de entrega para tu reclamación {claim_ref} ya está disponible.',
            'email_pod_failed_subject': 'POD no disponible - Acción requerida',
            'email_pod_failed_title': 'Recuperación de POD fallida',
            'email_pod_failed_message': 'No pudimos recuperar la prueba de entrega para tu reclamación {claim_ref}.',
            'email_pod_reason': 'Razón',
            'email_pod_action_required': 'Por favor verifica el número de seguimiento con el transportista.',
            'email_greeting': 'Hola',
            'email_signature_team': 'El Equipo Refundly',
            'email_view_claim': 'Ver reclamación',
            'email_manage_preferences': 'Puedes gestionar tus preferencias de notificación',
            'email_here': 'aquí',
            
            # Claims Management Page
            'claims_management_title': 'Gestión de Reclamaciones',
            ...
            'btn_delete_selection': 'Eliminar selección',
            'btn_confirm_delete': 'Confirmar eliminación',
            'btn_cancel': 'Cancelar',
            'delete_warning': 'Advertencia: ¡La eliminación es permanente!',
            ...
            'error_export': 'Error durante la exportación',
            'no_tracking': 'No se puede reintentar: número de seguimiento faltante',
            'rate_limit_reached': 'Límite de API alcanzado para {carrier}. Reintentar después de {time}',
            'retrieving_pod': 'Recuperando POD para {tracking}...',
            'pod_status_available': 'POD disponible - {claim_ref}',
            'pod_status_failed': 'POD fallido - {claim_ref}',
            'pod_status_fetching': 'POD en recuperación - {claim_ref}',
            'pod_retrieved_success': '¡POD recuperado con éxito!',
            'pod_retrieved_notification_failed': 'POD recuperado pero notificación fallida: {error}',
            'pod_failed_error': 'Fallido: {error}',
            'notification_failed': 'Notificación fallida: {error}',
            'notification_sent_persistent': 'Email enviado (error persistente)',
            'notification_temp_error': 'Error temporal - no se envió email',
            ...
            'bulk_retry_success_count': 'Éxito',
            'bulk_retry_failed_count': 'Fallido',
            'bulk_retry_skipped_count': 'Omitido (límite de tasa)',
            ...
            'pod_analytics_title': 'Analíticas POD',
            'pod_analytics_subtitle': 'Rendimiento de recuperación de pruebas de entrega',
            'time_range': 'Período',
            ...
            'overview_metrics': 'Visión general',
            'total_pods': 'Total PODs',
            ...
            'retry_analysis': 'Análisis de reintentos',
            'no_retry_data': 'No hay datos de reintento',
            'retry_summary': 'Resumen',
            'error_breakdown': 'Clasificación de errores',
            ...
            'store_management_caption': 'Añade, sincroniza o elimina tus tiendas de e-commerce',
            'connected_stores': 'Tus tiendas conectadas',
            'sync': 'Sincronizar',
            'delete': 'Eliminar',
            'store_deleted': 'Tienda eliminada',
            'confirm_delete': 'Haz clic de nuevo para confirmar',
            'no_stores': 'Aún no hay tiendas conectadas',
            'add_store': 'Añadir una nueva tienda',
            ...
            'add_this_store': 'Añadir esta tienda',
            'all_fields_required': 'Todos los campos son obligatorios',
            'store_added_success': '¡Tienda {store_name} añadida con éxito!',
            'error_adding_store': 'Error al añadir la tienda',
            'platform_info': 'Información de Plataforma',
            'platform_info_caption': 'Detalles de conexión a tu plataforma de e-commerce',
            ...
            'credentials_encrypted': 'Las credenciales completas están cifradas y almacenadas de forma segura',
            ...
            'bank_info_saved': 'Información bancaria guardada',
            'edit_bank_info': 'Editar mis datos bancarios',
            'no_bank_info': 'Aún no has proporcionado tus datos bancarios',
            'why_important': '¿Por qué es importante?',
            'bank_info_reason': 'Para recibir tus reembolsos automáticamente, necesitamos tu IBAN.',
            'add_bank_info': 'Añadir mis datos bancarios',
            'save': 'Guardar',
            'iban_holder_required': 'El IBAN y el titular de la cuenta son obligatorios',
            'bank_info_saved_success': '¡Datos bancarios guardados con éxito!',
            ...
            'notif_claim_created': 'Nueva reclamación creada',
            'notif_claim_updated': 'Reclamación actualizada',
            'notif_claim_accepted': 'Reclamación aceptada',
            'notif_payment_received': 'Pago recibido',
            'notif_deadline_warning': 'Plazo próximo (D-3)',
            'frequency': 'Frecuencia de envío',
            'frequency_caption': 'Elige cómo recibir tus notificaciones',
            'freq_immediate': 'Inmediato (tan pronto como ocurra el evento)',
            'freq_daily': 'Diario (resumen una vez al día a las 9:00)',
            'freq_weekly': 'Semanal (resumen el lunes por la mañana)',
            'frequency_tip': 'Consejo: si recibes muchas reclamaciones, el modo \'Diario\' evitará la sobrecarga de emails.',
            'save_preferences': 'Guardar mis preferencias',
            'preferences_saved': '¡Preferencias guardadas con éxito!',
            'email_templates': 'Plantillas de Email',
            'email_templates_caption': 'Personaliza el contenido de los emails de escalación automática',
            'templates_info': 'Puedes personalizar los emails enviados automáticamente durante las escalaciones (solicitud de estado, advertencia, requerimiento formal).',
            ...
            # Reports Page
            'reports_header': 'Informes y Análisis',
            'timeline_recent_events': 'Línea de Tiempo de Eventos Recientes',
            'timeline_caption': 'Historial cronológico de tus reclamaciones y acciones',
            'new_dispute': 'Nueva disputa detectada',
            'claim_submitted': 'Reclamación enviada',
            'refund_received': 'Reembolso recibido',
            'legal_escalation': 'Escalación legal',
            'sync_successful': 'Sincronización exitosa',
